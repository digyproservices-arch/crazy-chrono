        ...
        <div style={{ ...card, maxWidth: 450, textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 10, justifyContent: 'center' }}>
            ...
            {isAuthError ? (
              ...
              <button onClick={() => navigate(-1)} style={btn('#f1f5f9', '#334155')}>← Retour</button>
            )}
          </div>
        </div>
      </div>
    ...
    return (
      <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ ...card, maxWidth: 450, textAlign: 'center' }}>
          ...
          <button onClick={() => navigate(-1)} style={btn('#0D6A7A', '#fff')}>Retour</button>
        </div>
      </div>
    );
  }
    ...
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: '24px 16px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24, flexWrap: 'wrap', gap: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          ...
          <button onClick={() => navigate(-1)} style={btn('#f1f5f9', '#334155')}>
            ← Retour
          </button>
        </div>
      </div>
