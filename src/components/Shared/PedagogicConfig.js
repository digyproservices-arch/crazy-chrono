...
export const CATEGORY_LABELS = {
  ...
  'category:oiseau': '🐦 Oiseaux',
  'category:mammifere': '🐾 Mammifères',
  'category:reptile': '🦎 Reptiles',
  'category:poisson': '🐠 Poissons',
  'category:crustace': '🦀 Crustacés',
  'category:corail': '🪸 Coraux',
  'category:mollusque': '🐚 Mollusques',
...
export const CONTENT_DOMAINS = [
  ...
  { key: 'animaux', domain: 'domain:zoology', icon: '🐾', label: 'Animaux',
    color: '#ea580c', bg: '#fff7ed', tags: ['animaux', 'domain:zoology'],
    categories: ['category:oiseau', 'category:mammifere', 'category:reptile', 'category:poisson', 'category:crustace', 'category:corail', 'category:mollusque'],
    hasGeo: true },
